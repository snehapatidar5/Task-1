...
function Hero() {
  return (
    <div className='lg:max-2xl:h-screen  lg:max-2xl:bg-cover lg:max-2xl:flex  lg:max-2xl:justify-center  sm:overflow-x-hidden sm:[100%] ' style={{backgroundImage: `url(${background})`}}>
     ...
     <div>
        <div className='sm:my-2 sm:p-2 lg:max-2xl:mt-[160px] cursor-pointer'>
            <img src={testimonial} className='lg:max-2xl:w-[510px] lg:max-2xl:h-[310px] sm:w-[390px] sm:h-[236px]'/>
        </div>
     </div>
    </div>
  )
