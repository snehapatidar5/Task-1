...
function Benefit() {
  return (
    <div className="lg:max-2xl:flex lg:max-2xl:justify-evenly lg:max-2xl:mt-[-60px] ">
      <div>
              <img src={benefit} className="lg:max-2xl:w-[450px] lg:max-2xl:h-[600px] sm:w-[343px] h-[377px]  sm:m-4 " />
      </div>
      <div className="lg:max-2xl:w-[600px] lg:max-2xl:h-[700px]">
        <h3 className="text-[#12171B] lg:max-2xl:text-start lg:max-2xl:text-[40px] sm:text-[30px] font-semibold sm:text-center  ">
        ...
        <div className="lg:max-2xl:w-[552px]  sm:p-2">
          <h2 className="text-[25px] font-semibold text-[#272D39]">
            Benefits of Smart Leverage
          </h2>
          <div className='lg:max-2xl:flex lg:max-2xl:justify-between lg:max-2xl:p-1  sm:space-y-2'>
          <ul>
            <li className='flex'>
          ...
          <ul>
            <li className='flex'>                 
             <span><img src={check} className='w-[25px] h-[25px]'/></span> <p className='text-[#3A3939] text-[16px] pl-1 mr-[36px]'>No credit checks.</p>
            </li>
          </ul>
          </div>
          <div className='lg:max-2xl:flex  lg:max-2xl:justify-between lg:max-2xl:p-2 sm:space-y-2 sm:mt-2'>
          <ul>
              <li className='flex'>   
              <span><img src={check} className='w-[25px] h-[25px]'/></span> <p className='text-[#3A3939] text-[16px] pl-1'>No personal guarantees.</p>
              </li>
          </ul>
          <ul>
             <li className='flex'>               
        ...
        <div className='sm:p-2'>
          ...
          <ul className=' lg:max-2xl:p-2  sm:space-y-2'>
            <li className='flex lg:max-2xl:ml-[3px] '>                  
          ...
          <div className='lg:max-2xl:flex lg:max-2xl:justify-between lg:max-2xl:p-3 sm:space-y-2 sm:mt-2'>
          <ul>
        <li className='flex'>  
       ...
       <li className='flex'>            
          ...
          <div className=' '>
            ...
            <ul className=" lg:max-2xl:p-1 sm:space-y-2 sm:mt-2">
            ...
            <ul className=" lg:max-2xl:p-2 sm:mt-2">
              <li className="flex  gap-2 text-gray-800 ">
